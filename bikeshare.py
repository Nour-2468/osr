    ...
    while true:
        ...
        try:
            if input_read in ['chicago','new york city','washington']and input_type==1:
                ...
                if input_type==3:
                    print("sorry,your input should be:sunday,monday,tuesday,wednesday,thursday,friday,saturday or all")                                                                             
        except valueError:
...
def get_filtets():
    ...
    city=check input("Would you like to see the data for chicago, new york city or washington?",1)
    # get user input for month (all, january, february, ... , june)
    month=check input("Which Month (all, january, ... june)?",2)
    # get user input for day of week (all, monday, tuesday, ... sunday)
    day=check input("Which day? (all, monday, tuesday, ... sunday)",3)
    print('_'*40)
